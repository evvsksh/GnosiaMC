...
execute if entity @s[tag=!cantClaim] if score showRoleActionbar gameStatus matches 1 if score @s logReportIndexEngineer matches 1.. run function gnosia:log/reports/index_update_role_engineer
