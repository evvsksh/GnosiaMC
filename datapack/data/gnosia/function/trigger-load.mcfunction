...
scoreboard objectives add engineerReportHuman trigger
scoreboard objectives add engineerReportGnosia trigger
scoreboard objectives add doctorReportHuman trigger
scoreboard objectives add doctorReportGnosia trigger
scoreboard objectives add noReport trigger

scoreboard objectives add makeReport trigger
