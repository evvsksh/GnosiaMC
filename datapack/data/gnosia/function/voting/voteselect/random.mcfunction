...
execute if score revoteAmount voteCheck matches 0 store result score @s vote_select run scoreboard players get @r[tag=!dead,tag=!self_vote_prevention] playersID
