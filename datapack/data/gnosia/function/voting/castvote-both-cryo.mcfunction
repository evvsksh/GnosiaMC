execute if score @s alreadyVotedCryo matches 0 if score cryoPhase voteCheck matches 1 run scoreboard players add bothCryo revoteCryo 1
...
execute if score @s alreadyVotedCryo matches 0 if score cryoPhase voteCheck matches 1 run tellraw @a [{"selector":"@s"}," voted to",{"bold":true,"color":"aqua","text":" Freeze Everyone"}]
execute if score @s alreadyVotedCryo matches 0 if score cryoPhase voteCheck matches 1 run function gnosia:log/vote/list_final_all
