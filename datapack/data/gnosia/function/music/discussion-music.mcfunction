...
execute store result score discussion-music music run random value 1..4
execute if score discussionlastPlayed music = discussion-music music if score discussion-music music matches 2..4 run scoreboard players remove discussion-music music 1
execute if score discussionlastPlayed music = discussion-music music if score discussion-music music matches 1 run scoreboard players add discussion-music music 1

execute if score discussion-music music matches 1 run playsound gnosia:ost.gnosia-is-you record @a ~ ~ ~ .2 1 .2
execute if score discussion-music music matches 2 run playsound gnosia:ost.suspicion-anime record @a ~ ~ ~ .2 1 .2
execute if score discussion-music music matches 3 run playsound gnosia:ost.suspicion record @a ~ ~ ~ .2 1 .2
execute if score discussion-music music matches 4 run playsound gnosia:ost.in-the-unknown-ship record @a ~ ~ ~ .2 1 .2

scoreboard players operation discussionlastPlayed music = discussion-music music

schedule function gnosia:music/discussion-music 233.8s
