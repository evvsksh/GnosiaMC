...
execute if score @s engineerID matches 1.. run setblock -299 88 -1610 oak_wall_sign[facing=east]{front_text:{messages:[{text:"\n",color:"#187fc4",extra:[" reported "," as ",{color:"#e60039",text:"Gnosia"}]},{selector:"@a[tag=log_event_report_gnosia]"},{selector:"@a[tag=log_report]"},""]}}
execute if score @s doctorID matches 1.. run setblock -299 88 -1610 oak_wall_sign[facing=east]{front_text:{messages:[{text:"\n",color:"#8376b5",extra:[" reported "," as ",{color:"#e60039",text:"Gnosia"}]},{selector:"@a[tag=log_event_report_gnosia]"},{selector:"@a[tag=log_report]"},""]}}
