tag @s add log_event_report_human
execute if score @s engineerID matches 1.. run setblock -299 88 -1610 oak_wall_sign[facing=east]{front_text:{messages:[{text:"\n",color:"#187fc4",extra:[" reported "," as ",{color:"#6eba2b",text:"Human"}]},{selector:"@a[tag=log_event_report_human]"},{selector:"@a[tag=log_report]"},""]}}
execute if score @s doctorID matches 1.. run setblock -299 88 -1610 oak_wall_sign[facing=east]{front_text:{messages:[{text:"\n",color:"#8376b5",extra:[" reported "," as ",{color:"#6eba2b",text:"Human"}]},{selector:"@a[tag=log_event_report_human]"},{selector:"@a[tag=log_report]"},""]}}
data modify block -299 88 -1610 front_text.messages[0].extra prepend from block -299 88 -1610 front_text.messages[1].extra
data modify block -299 88 -1610 front_text.messages[0].extra insert -3 from block -299 88 -1610 front_text.messages[2].extra
...
tag @s remove log_event_report_human