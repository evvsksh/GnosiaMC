...
setblock -299 88 -1610 oak_wall_sign[facing=east]{front_text:{messages:[{color:white,text:"\n",extra:["",{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""},{color:white,text:""}]},{selector:"@e[tag=log_report_engineer]"},"",""]}}
