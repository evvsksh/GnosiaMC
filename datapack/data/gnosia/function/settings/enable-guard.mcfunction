...
execute if score enableGuard rolesCheck matches 1 run scoreboard players set count displayGuard 2
execute unless score enableGuard rolesCheck matches 1 run scoreboard players set count displayGuard 0
